...
public class Sudoku4 extends JFrame implements ActionListener {
    ...
    public void validador1to9() {
        extraerNumeros();
        int v = 0;
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 9; j++) {
                try {
                    v = Integer.parseInt(matriz[i][j]);
                    if ((v < 1) || (v > 9)) {
                        fueraDeRango = true;
                        matriz[i][j] = "";
                    }
        ...
        if (fueraDeRango) {
            JOptionPane.showMessageDialog(null, "Hay numeros fuera del Rango 1-9");
        }
    }
    ...
    public void GenerarNumeros() {
        ...
        x = rnd.nextInt(9) + 1;
        txt01.setText(String.valueOf(x));
        txt01.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt10.setText(String.valueOf(x));
        txt10.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt11.setText(String.valueOf(x));
        ...
        x = rnd.nextInt(9) + 1;
        txt13.setText(String.valueOf(x));
        txt13.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt26.setText(String.valueOf(x));
        txt26.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt38.setText(String.valueOf(x));
        txt38.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt41.setText(String.valueOf(x));
        txt41.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt64.setText(String.valueOf(x));
        txt64.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt87.setText(String.valueOf(x));
        txt87.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt33.setText(String.valueOf(x));
        txt33.setEditable(false);

        x = rnd.nextInt(9) + 1;
        txt62.setText(String.valueOf(x));
        ...
        x = rnd.nextInt(9) + 1;
        txt55.setText(String.valueOf(x));
        txt55.setEditable(false);

    }

    public void validadorDeRandom() {
        GenerarNumeros();
        if (txt00.getText().equals(txt11.getText())
                || txt00.getText().equals(txt22.getText())
                || txt11.getText().equals(txt22.getText())) {
            GenerarNumeros();
        }
